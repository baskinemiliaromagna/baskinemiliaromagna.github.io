...
<link rel="stylesheet" id="forms-css" href="https://baskinemiliaromagna.github.io/wp-admin/css/forms.min.css?ver=6.1.1" type="text/css" media="all">
<link rel="stylesheet" id="l10n-css" href="https://baskinemiliaromagna.github.io/wp-admin/css/l10n.min.css?ver=6.1.1" type="text/css" media="all">
<link rel="stylesheet" id="login-css" href="https://baskinemiliaromagna.github.io/wp-admin/css/login.min.css?ver=6.1.1" type="text/css" media="all">
...
<meta name="msapplication-TileImage" content="https://baskinemiliaromagna.github.io/wp-content/uploads/2020/01/cropped-emilia-romagna-baskin-1000x1000-1-270x270.png">
	...
	<script type="text/javascript">document.body.className = document.body.className.replace('no-js','js');</script>
		...
		<form name="loginform" id="loginform" action="http://www.baskinemiliaromagna.it/wp-login.php" method="post">
			<p>
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Accedi">
					...
					<p id="nav">
				<a href="https://baskinemiliaromagna.github.io/wp-login.php?action=lostpassword">Password dimenticata?</a>			</p>
...
if ( typeof wpOnload === 'function' ) { wpOnload() }</script>
		...
		<div class="privacy-policy-page-link"><a class="privacy-policy-link" href="https://baskinemiliaromagna.github.io/privacy/">Privacy</a></div>	</div>
...
<option value="it_IT" lang="it" selected data-installed="1">Italiano</option></select>
				...
				<script type="text/javascript" src="https://baskinemiliaromagna.github.io/wp-includes/js/jquery/jquery.min.js?ver=3.6.1" id="jquery-core-js"></script>
...
<script type="text/javascript" src="https://baskinemiliaromagna.github.io/wp-includes/js/dist/vendor/regenerator-runtime.min.js?ver=0.13.9" id="regenerator-runtime-js"></script>
<script type="text/javascript" src="https://baskinemiliaromagna.github.io/wp-includes/js/dist/vendor/wp-polyfill.min.js?ver=3.15.0" id="wp-polyfill-js"></script>
<script type="text/javascript" src="https://baskinemiliaromagna.github.io/wp-includes/js/dist/hooks.min.js?ver=4169d3cf8e8d95a3d6d5" id="wp-hooks-js"></script>
<script type="text/javascript" src="https://baskinemiliaromagna.github.io/wp-includes/js/dist/i18n.min.js?ver=9e794f35a71bb98672ae" id="wp-i18n-js"></script>
...
<script type="text/javascript" src="https://baskinemiliaromagna.github.io/wp-admin/js/password-strength-meter.min.js?ver=6.1.1" id="password-strength-meter-js"></script>
<script type="text/javascript" src="https://baskinemiliaromagna.github.io/wp-includes/js/underscore.min.js?ver=1.13.4" id="underscore-js"></script>
...
<script type="text/javascript" id="user-profile-js-translations">( function( domain, translations ) {
	...
	localeData[""].domain = domain;
	wp.i18n.setLocaleData( localeData, domain );
} )( "default", {"translation-revision-date":"2022-11-15 15:33:35+0000","generator":"GlotPress\/4.0.0-alpha.3","domain":"messages","locale_data":{"messages":{"":{"domain":"messages","plural-forms":"nplurals=2; plural=n != 1;","lang":"it"},"Your new password has not been saved.":["La tua nuova password non è stata salvata."],"Hide":["Nascondi"],"Show":["Visualizza"],"Confirm use of weak password":["Conferma l'uso della password debole."],"Hide password":["Nascondi password"],"Show password":["Mostra password"]}},"comment":{"reference":"wp-admin\/js\/user-profile.js"}} );</script>
<script type="text/javascript" src="https://baskinemiliaromagna.github.io/wp-admin/js/user-profile.min.js?ver=6.1.1" id="user-profile-js"></script>
	<div class="clear"></div>
	</body>
	</html>